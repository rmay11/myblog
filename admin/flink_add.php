...
if($sub){
	$name=$_POST['url_name'];
	$url=$_POST['url'];
	$conn->query("insert into flink (url_name,url) values('$name','$url')");
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">作品管理</a><span class="crumb-step">&gt;</span><span>新增友链</span></div>
        </div>
