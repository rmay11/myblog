...
if($sub){
	...
	$conn->query("update  users set username='$new_username' ,password='$password' where username='$username'");
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="url_name" name="username" size="50" value="<?php echo $username; ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>新密码：</th>
                            <td>
                                <input class="common-text required" id="url" name="password" size="50" value="" type="password">
                            </td>
                        </tr>
